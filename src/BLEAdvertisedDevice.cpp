    ...
    if (length != 0) {  // A length of 0 indicates that we have reached the end.
      ...
      switch (ad_type) {
        ...
        {                                // Adv Data Type: ESP_BLE_AD_TYPE_NAME_CMPL
          setName(bytesToString(payload, length));
          break;
        }  // 0x09
        ...
        {
          setManufacturerData(bytesToString(payload, length));
          break;
        }  // 0xFF
        ...
        {                                   // Adv Data Type: ESP_BLE_AD_TYPE_SERVICE_DATA - 2 byte UUID
          ...
          if (length > 2) {
            setServiceData(bytesToString(payload + 2, length - 2));
          }
          break;
        }  // 0x16
        ...
        {                                     // Adv Data Type: ESP_BLE_AD_TYPE_32SERVICE_DATA - 4 byte UUID
          ...
          setServiceDataUUID(BLEUUID(uuid));
          if (length > 4) {
            setServiceData(bytesToString(payload + 4, length - 4));
          }
          break;
        }  // 0x20
        ...
        {                                      // Adv Data Type: ESP_BLE_AD_TYPE_128SERVICE_DATA - 16 byte UUID
          ...
          if (length > 16) {
            setServiceData(bytesToString(payload + 16, length - 16));
          }
          break;
        }  // 0x21
