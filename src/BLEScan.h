...
#if defined(CONFIG_BLUEDROID_ENABLED) && defined(SOC_BLE_50_SUPPORTED) && SOC_BLE_50_SUPPORTED
...
#if defined(SOC_BLE_50_SUPPORTED) && SOC_BLE_50_SUPPORTED && defined(CONFIG_BLUEDROID_ENABLED)
