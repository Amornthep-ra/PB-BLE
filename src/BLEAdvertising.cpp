...
void BLEAdvertisementData::addData(char *data, size_t length) {
  ...
  m_payload.concat(bytesToString((uint8_t *)data, length));
}  // addData
...
void BLEAdvertisementData::setAppearance(uint16_t appearance) {
  ...
  addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&appearance, 2));
}  // setAppearance
...
void BLEAdvertisementData::setCompleteServices(BLEUUID uuid) {
  ...
  switch (uuid.bitSize()) {
    ...
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->uuid.uuid16, 2));
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->u16.value, 2));
#endif
      break;
    }
...
#if defined(CONFIG_BLUEDROID_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->uuid.uuid32, 4));
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->u32.value, 4));
#endif
      break;
    }
...
#if defined(CONFIG_BLUEDROID_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)uuid.getNative()->uuid.uuid128, 16));
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)uuid.getNative()->u128.value, 16));
#endif
      break;
    }
...
void BLEAdvertisementData::setFlags(uint8_t flag) {
  ...
  cdata[2] = flag;
  addData(bytesToString((uint8_t *)cdata, 3));
}  // setFlag
...
void BLEAdvertisementData::setManufacturerData(String data) {
  ...
  addData(bytesToString((uint8_t *)cdata, 2) + data);
  log_d("BLEAdvertisementData", "<< setManufacturerData");
}  // setManufacturerData
...
void BLEAdvertisementData::setName(String name) {
  ...
  addData(bytesToString((uint8_t *)cdata, 2) + name);
...
#if defined(CONFIG_BLUEDROID_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->uuid.uuid16, 2) + data);
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->u16.value, 2) + data);
#endif
      break;
    }
...
#if defined(CONFIG_BLUEDROID_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->uuid.uuid32, 4) + data);
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->u32.value, 4) + data);
#endif
      break;
    }
...
#if defined(CONFIG_BLUEDROID_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)uuid.getNative()->uuid.uuid128, 16) + data);
#endif
#if defined(CONFIG_NIMBLE_ENABLED)
    addData(bytesToString((uint8_t *)cdata, 2) + bytesToString((uint8_t *)&uuid.getNative()->u128.value, 16) + data);
#endif
      break;
    }
...
#if defined(SOC_BLE_50_SUPPORTED) && SOC_BLE_50_SUPPORTED
